...
8. Incluí una acción \`respond\` si hay acciones CRUD que confirmar, o si la vía rápida no respondió, **o si tu respuesta agrega información valiosa que la vía rápida no tenía** (ej: datos concretos de la base de datos cuando la fast lane dijo que no había contexto). Si la vía rápida ya respondió con información completa y no hay CRUD, omití el \`respond\`. Si incluís \`respond\`, las confirmaciones van como mensajes dentro del mismo. NO generes mensajes separados por acción.
9. Si recibiste la sección ## Respuesta anterior (vía rápida), tu respuesta debe COMPLEMENTAR lo que ya se dijo. No repitas información. Añadí detalles, confirmaciones de acciones ejecutadas, o data que la vía rápida no tenía disponible. Si la vía rápida respondió con información incompleta o incorrecta, **corregila** con tu respuesta.
